...
1. Retrieves the file attached to the last user message via `message.attachments`.
...
- [`examples/excel-query`](../../examples/excel-query/README.md) — A complete implementation of this template applied to expense report review, including sample data and ready-to-test scenarios.
